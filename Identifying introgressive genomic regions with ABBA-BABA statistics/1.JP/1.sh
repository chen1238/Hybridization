...
python ../ABBABABAwindows.py -g ./mus.geno.gz -f phased -o jp.ABBA.csv -w 100000 -s 20000 -m 100 -T 10 -P1 m -P2 h -P3 c -O o --popsFile jp.txt --writeFailedWindows 

python ../popgenWindows.py -g ./mus.geno.gz -f phased -o jp.pop.csv -w 100000 -s 20000 -m 100 -T 10 -p m -p h -p c -p o --popsFile jp.txt --writeFailedWindows 
