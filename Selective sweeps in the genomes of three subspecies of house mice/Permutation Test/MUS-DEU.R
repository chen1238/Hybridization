...
k1 <- 922  # MUS 中受选择的基因数
k2 <- 863  # DEU 中受选择的基因数
observed_overlap <- 172  # 观察到的重叠基因数
...
# 绘制置换生成的重叠分布直方图
hist(random_overlaps, breaks = 50, main = "Distribution of Overlaps from Permutation Test (MUS-DEU)",
     xlab = "Number of Overlaps", col = "#a5f165", border = "white")
