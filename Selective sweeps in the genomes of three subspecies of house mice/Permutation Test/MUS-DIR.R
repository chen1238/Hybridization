...
observed_overlap <- 254  # 观察到的重叠基因数
...
# 绘制置换生成的重叠分布直方图
hist(random_overlaps, breaks = 50, main = "Distribution of Overlaps from Permutation Test (MUS-DIR)",
     xlab = "Number of Overlaps", col = "#3fee56", border = "white")
