...
k2 <- 863  # DEU 中受选择的基因数
observed_overlap <- 102  # 观察到的重叠基因数
...
# 绘制置换生成的重叠分布直方图
hist(random_overlaps, breaks = 50, main = "Distribution of Overlaps from Permutation Test (CAS2-DEU)",
     xlab = "Number of Overlaps", col = '#f19f65', border = "white")
