# 设置参数
N <- 21859  # 总基因数
k1 <- 1010  # CAS2 中受选择的基因数
k2 <- 1311  # DIR 中受选择的基因数
observed_overlap <- 137  # 观察到的重叠基因数
...
# 绘制置换生成的重叠分布直方图
hist(random_overlaps, breaks = 50, main = "Distribution of Overlaps from Permutation Test (CAS2-DIR)",
     xlab = "Number of Overlaps", col = "#f1db65", border = "white")
